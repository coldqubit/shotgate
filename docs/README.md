...
| [Pipeline Schema](pipeline.md) | How qforge gates a CI/CD pipeline; stage contract; exit codes. |
| [Workflow Specification](workflow-spec.md) | The `qforge.dev/v1alpha1` YAML schema, field by field. |
